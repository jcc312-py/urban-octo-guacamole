#!/usr/bin/env python3
"""
Comprehensive test script for indentation and docstring fixes
This script tests various malformed code scenarios and verifies they're fixed properly
"""

def test_various_malformed_codes():
    """Test various malformed code scenarios"""
    print("🧪 Testing various malformed code scenarios...")
    
    test_cases = [
        {
            "name": "Missing docstring quotes",
...
return None'''
    ...
    for i, test_case in enumerate(test_cases, 1):
        ...
        fixed_code = fix_code_comprehensive(test_case['code'])
...
def fix_code_comprehensive(code: str) -> str:
    """
    Comprehensive code fixing logic
    """
    lines = code.split('\n')
    fixed_lines = []
    in_function = False
    ...
    for i, line in enumerate(lines):
        ...
        if docstring_content and not in_docstring and docstring_level == 0:
...
def test_improved_prompt_effectiveness():
    """Test the effectiveness of the improved prompt"""
...
"""
    ...
    print("✅ Triple quote requirements for docstrings")
    print("✅ 4-space indentation for all function content")
    
    return improved_prompt

def main():
    """Main test function"""
    print("🚀 Starting comprehensive indentation fix tests...")
    
    # Test various malformed code scenarios
    test_various_malformed_codes()
    
    # Test the improved prompt
    improved_prompt = test_improved_prompt_effectiveness()
    
    print("\n🎉 Comprehensive indentation fix tests completed!")
    print("💡 The improved prompts and fixing logic should handle most indentation issues!")
